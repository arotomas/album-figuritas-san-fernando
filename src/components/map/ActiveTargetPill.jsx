...
function ActiveTargetPillInner({ figureName, onCancel }) {
  ...
  return (
    <div className="safe-top pointer-events-auto absolute inset-x-4 top-4 z-[520] flex justify-center">
      <div className="flex max-w-full items-center gap-2 rounded-full border border-progress/35 bg-zinc-950/95 px-3 py-2 shadow-[0_8px_28px_rgba(0,0,0,0.45)]">
