...
export function MyFiguresScreen() {
  ...
  const arrowButtonClass =
    'flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-border/70 bg-white/90 text-ink shadow-md disabled:pointer-events-none disabled:opacity-30 active:scale-95'
  ...
  return (
    <div className="my-figures-screen relative flex h-full min-h-0 flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col overflow-hidden">
        <header className="my-figures-header shrink-0 px-6 pb-3 pt-4">
        ...
        <div className="my-figures-scroll scroll-y-app min-h-0 flex-1 px-4">
          <div className="my-figures-featured flex min-h-0 flex-col items-center justify-center py-2">
            {mobileLayout ? (
            ...
            <AnimatePresence mode="wait">
              <m.p
                ...
                className={`${albumClasses.hint} mt-3 shrink-0 text-center`}
              >
